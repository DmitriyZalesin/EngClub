...
class PartyViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        priceLabel.text = prices[idx] + " BYN(в номинале 2009)"
        ...
        let lawyerLocation: CLLocationCoordinate2D = CLLocationCoordinate2DMake(53.9050563, 27.5393463)
        let annotation = MKPointAnnotation()
        annotation.coordinate = lawyerLocation
        annotation.title = "Офис BlahBlahClub"
